...
<body>
    ...
    <div class="container">
        <form action="{{ isset($jurados) ? 'https://deployrailway-production-3bd5.up.railway.app'.('/jurados/' . $jurados->id) : 'https://deployrailway-production-3bd5.up.railway.app'.('/jurados') }}"
